		...
		<div class="index_input_body_third">
			<div class="index_input_body_third_header clearfix">
				<div class="index_input_body_third_header_1">
					<i class="icon iconfont icon-santiaogang"></i><span>品牌编辑</span>
				</div>
			...
			<div class="index_input_body_third_body">
				...
				<form action="ProductBrandServlet.do" method="post">
					<input type="hidden" name="method" value="save" /> <input
						type="hidden" name="brand_id" value="${ProductBrand4.brand_id}" />
					<div class="index_input_body_third_body_all clearfix">
						<div class="index_input_body_third_body_1 clearfix"
							style="display:${displaystatus}">
							<div class="c888 fsz14 index_input_body_third_body_style1">品牌id:</div>

							<div>
								<input class="index_input_style1" type="text" name="brand_id"
									id="brand_id" disabled="disabled" value="${ProductBrand4.brand_id}" />
						...
						<div class="index_input_body_third_body_1 clearfix">
							...
							<div>
								<input class="index_input_style1" type="text" id="brand_name"
									name="brand_name" />
							</div>
						</div>
						...
						<div class="index_input_body_third_body_1 clearfix">
							<div class="c888 fsz14 index_input_body_third_body_style1">品牌图片路径：</div>

							<div>
								<input class="index_input_style1" type="text" id="brand_img"
									name="brand_img" />
							</div>
						</div>
						<!--<div class="index_input_body_third_body_1 clearfix">
