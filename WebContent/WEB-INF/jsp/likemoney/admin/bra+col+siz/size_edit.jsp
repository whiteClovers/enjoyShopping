		...
		<div class="index_input_all">
			...
			<div class="index_input_body_third">
				...
				<div class="index_input_body_third_body">
						...
						type="hidden" name="size_id" value="${ProductSize4.size_id}" />
						<div class="index_input_body_third_body_all clearfix">
						<div class="index_input_body_third_body_1 clearfix"
							style="display:${displaystatus}">
							<div class="c888 fsz14 index_input_body_third_body_style1">尺寸id:</div>

							<div>
								<input class="index_input_style1" type="text" name="size_id"
									id="size_id" disabled="disabled" value="${ProductSize4.size_id}" />
							...
							<div class="index_input_body_third_body_1 clearfix">
								...
								<div>
									<input class="index_input_style1" type="text"  id="size_name"
									name="size_name"/>
								</div>
							</div>
