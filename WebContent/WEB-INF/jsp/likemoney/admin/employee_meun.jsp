...
<link href="${pageContext.request.contextPath}/img/.png" rel="SHORTCUT ICON" />
	...
	<div>
		...
		<div class="manage_index_fixed">
			...
			<div class="manage_index_fixed_top clearfix">
				...
				<div class="manage_index_fixed_top_4 " style="float: right;">
					<ul class="manage_index_fixed_top_4_ul clearfix">
						<li><span>&nbsp;部门经理</span> <i class="icon iconfont icon-f11"></i>
						</li>
						<li class="mar_le20">
							<!--<img src="img/manage_index_header.jpg" />-->
						</li>
			...
			<div class="manage_index_fixed_bottom">
				<span>Made_in 2018-8-11 &nbsp;版权归xx所有</span>
			</div>
		</div>
