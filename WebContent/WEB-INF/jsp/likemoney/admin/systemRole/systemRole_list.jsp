		...
		<div class="manage_table_all">
			...
			<div class="index_input_body_second">
				<ul class="clearfix">
					...
					<li>
						<form action="SystemRoleServlet.do?method=list"  method="post">
							<span>角色名：</span>
			...
			<div class="table_body_first table_style2 border_style5">
				<div class="table_body_first_header bgc_f37b53  clearfix">
					...
					<div class="table_body_first_header_1">
							<a href="SystemRoleServlet.do?method=edit"><!-- 新增	-->
								>>>新增
							</a>
					</div>
					...
					<table border="" cellspacing="0" style="width: 1610px;">
						<thead>
							<tr>
								...
								<th class="width_style5 bgcddd c666 "> 角色ID</th>
								<th class="width_style5 bgcddd c666 "> 角色名</th>
						...
						<tbody>
							<c:forEach items="${list }" var="sm"><!-- 修改  -->
								<tr>
									<td class="bgc_f9 ">
										<button class="button_style6">
											<a href="SystemRoleServlet.do?method=edit&roleId=${sm.roleId }"><!-- 修改  -->
												<i class="icon iconfont icon-bi"></i>
											</a>
										</button>
										<button class="button_style7"><!-- 修改  -->
							<!-- 修改  -->		<a href="SystemRoleServlet.do?method=delete&roleId=${sm.roleId }">										
												<i class="icon iconfont icon-shanchu"></i>
											</a>
										</button>
	
									</td>
									<td class="bgc_f9 c4a8bc2 ">${sm.roleId }</td><!-- 修改  -->
									<td class="bgc_f9 ">${sm.roleName }</td><!-- 修改  -->
								</tr>
							</c:forEach>
						</tbody>
