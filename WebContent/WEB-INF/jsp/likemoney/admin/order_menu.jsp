			...
			<div class="manage_index_important">
				...
				<div class="manage_index_body_first clearfix">
					<div class="box_small manage_index_body_first_1 clearfix">
						<a href="OrderServlet.do?method=list">
							<div class="box_pad_style">
								<i class="icon iconfont icon-gouwuche box_pad_style4"></i>
								<div class="box_pad_style3 fsz20">321</div>
							</div>
							<div class="box_pad_style2">订单管理</div>
						</a>

					</div>
					<div class="box_small manage_index_body_first_2">
						<a href="OrderDetailServlet.do?method=list">
							<div class="box_pad_style">
								<i class="icon iconfont icon-bianqiangai box_pad_style4"></i>
								<div class="box_pad_style3 fsz20">970</div>
							</div>
							<div class="box_pad_style2">订单明细管理</div>
						</a>

					</div>
					<div class="box_small manage_index_body_first_3">
						<a href="OrderServlet.do?method=edit">
							<div class="box_pad_style">
								<i class="icon iconfont icon-gouwuche box_pad_style4"></i>
								<div class="box_pad_style3 fsz20">49</div>
							</div>
							<div class="box_pad_style2">订单评价管理</div>
						</a>
			...
			<div class="manage_index_fixed_top clearfix">
				...
				<div class="manage_index_fixed_top_4 " style="float: right;">
					<ul class="manage_index_fixed_top_4_ul clearfix">
						<li><span>&nbsp;销售经理</span> <i class="icon iconfont icon-f11"></i>
						</li>
						<li class="mar_le20"><img
							src="admin_img/manage_index_header_01.jpg" /></li>
			...
			<div class="manage_index_fixed_body">
				...
				<div class="manage_index_fixed_middle">
					<a href="">
						...
						<div class="manage_index_fixed_middle_div_style">
							<i class="icon iconfont icon-shu"></i>&nbsp;&nbsp; <span>菜单</span>
							<i class="icon iconfont icon-arrow-fill-right i_style1"></i>
